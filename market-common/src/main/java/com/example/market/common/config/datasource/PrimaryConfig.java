package com.example.market.common.config.datasource;
...
@EnableJpaRepositories(
        ...
        basePackages = {"com.example.market.common.mysql.repo"}) //设置Repository所在位置
public class PrimaryConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryPrimary(EntityManagerFactoryBuilder builder) {
        return builder
                ...
                .packages("com.example.market.common.mysql.entity")
