...
import com.example.market.common.validation.SearchArea;
import com.example.market.common.validation.TimeType;
...
public class VoParams extends VoPage {
     ...
     */
    @ApiModelProperty(value = "搜索范围 all>>全部,title>>标题,content>>内容")
    @SearchArea
